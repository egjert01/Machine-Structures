...
extern void build_mul_div_test(Seq_T instructions);
extern void build_nand_test(Seq_T instructions);
extern void build_cond_move_test(Seq_T instructions);
extern void build_map_unmap_test(Seq_T instructions);
extern void build_loadp_segloadstore_test(Seq_T instructions);
extern void build_io_test(Seq_T instructions);
extern void build_extended_map_unmap_test(Seq_T instructions);
extern void build_pcounter_test(Seq_T stream);
...
static struct test_info {
        ...
        { "mul-div",            NULL, "PZ", build_mul_div_test },
        { "nand",               NULL, "l",  build_nand_test },
        { "cond-move",          NULL, "dx", build_cond_move_test },
        { "map-unmap",          NULL,  "",  build_map_unmap_test },
        { "io",                 "abc123",  "abc123", build_io_test },
        { "loadp-segloadstore", NULL,  "_", build_loadp_segloadstore_test },
        { "pcounter",           NULL,  "",  build_pcounter_test },
        { "extended-map-unmap",  NULL,  "",  build_extended_map_unmap_test }
};
